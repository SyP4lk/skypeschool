...
const [dynCategories, setDynCategories] = useState<Category[]>([]);
...
useEffect(() => {
  ...
  fetch('/data/popular-lessons.json', { cache: 'no-store' })
    ...
    .then((j) => {
      ...
      setDynCategories(mapped);     // если пусто — оставим []
      setHasLoaded(true);
    })
      ...
      <section className={styles.hero}>
        ...
        <div className="container">
          ...
          <p className={styles.heroSubtext} data-aos="fade-up" data-aos-delay="200" data-aos-offset="0">
            Индивидуальные занятия с проверенными преподавателями <br />
            Подберём преподавателя под вашу цель
          </p>
        </div>
      </section>
...
{hasLoaded && dynCategories.length > 0 && (
  <section className={styles.categories}>
    <MouseRepelField
      ...
      pointSize={2}
      pointColor="rgba(59,130,246,0.9)"
      mouseRadius={130}
      mousePower={900}
      mouseMode="repel"
    />
