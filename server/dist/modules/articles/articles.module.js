...
exports.ArticlesModule = ArticlesModule = __decorate([
    (0, common_1.Module)({
        controllers: [articles_controller_1.ArticlesController, admin_articles_controller_1.AdminArticlesController],
        providers: [prisma_service_1.PrismaService, articles_service_1.ArticlesService],
    })
], ArticlesModule);
